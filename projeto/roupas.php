...
<div style="border: 3px solid black; margin-top: 1%; margin-left: 2%; margin-right: 2%; background-color: #BEBEBE;">  
...
<div class="row">
  <div class="col-sm-3 col-xs-12 col-md-3">
    <div class="card mb-4">
      <img class="card-img-top" src="img/livroo1.jpg" alt="Card image cap">
      <div class="card-body">
