      ...
      <div class="col-sm-3 col-xs-12 col-md-3">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary">R$ 949,00  <i class="fa fa-shopping-cart"></i></a>
            <details>
     ...
     <div class="col-sm-3 col-xs-12 col-md-3">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary">R$ 815,00  <i class="fa fa-shopping-cart"></i></a>
          <details>
           <summary>Detalhes</summary> 
   ...
   <div class="col-sm-3 col-xs-12 col-md-3">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <a href="#" class="btn btn-primary">R$ 3.785,00  <i class="fa fa-shopping-cart"></i></a>
        <details>
         <summary>Detalhes</summary> 
         <p>--------</p>
 ...
 <div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 3.299,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 579,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 699,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
     <h5 class="card-title">Asus Zenfone 4 Selfie</h5> 
      <a href="#" class="btn btn-primary">R$ 1.399,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 5.079,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 899,00  <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 1.329,00  <i class="fa fa-shopping-cart"></i></a>
...
<div class="col-sm-3 col-xs-12 col-md-3">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">R$ 619,00 <i class="fa fa-shopping-cart"></i></a>
      <details>
       <summary>Detalhes</summary> 
