    ...
    <div class="card-deck">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-light-blue btn-md"><a href="eletronicos.php"> Saiba mais</a></button>
        </div>
      </div>
      <div class="card mb-4">
        <div class="view overlay">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-light-blue btn-md"><a href="roupas.php">Saiba mais</a></button>
        </div>
      </div>
      <div class="card mb-4">
        <div class="view overlay">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-light-blue btn-md"><a href="game.php">Saiba mais</a></button>
        </div>
      </div>
    </div>
    <div class="card-deck">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-light-blue btn-md"><a href="livros.php">Saiba mais</a></button>
        </div>
      </div>
      <div class="card mb-4">
        <div class="view overlay">
