<?php
  ...
  <div style="margin-left: 3%;">
      ...
      <?php 
        ...
        $query2 = "select * from produto  where categoria = 'Livros'";
        $consulta2 = mysqli_query($con, $query2);
        $total = mysqli_num_rows($consulta2);

        $query = "select * from produto where categoria = 'Livros' limit $inicial, $exibir";
  ...
  <?php echo "<div class='text-center'>"; 
    echo "<div><a class='btn btn-primary' href='livros.php?pi=0&exibir=$exibir'>Primeiro</a>";
        for($i = 1; $i <= $paginas; $i++){
         if($i == 1){
          $pi = 0;
           }else{
        ...
        echo "<a class='btn btn-primary' href='livros.php?pi=$pi&exibir=$exibir'>$i</a>";
        }
        echo "<a class='btn btn-primary' href='livros.php?pi=$pi&exibir=$exibir'>ultimo</a></div>";
        echo "</div>"
  ?> 
 <footer>
